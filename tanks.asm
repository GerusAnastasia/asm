...
get_enemy_tank_sprite proc; cx - enemy_index; output: ax - enemy_tank_sprite
    ...
    cmp al, direction_up
    je get_tank_sprite_up
    cmp al, direction_down
    je get_tank_sprite_down
    cmp al, direction_left
    je get_tank_sprite_left
    jmp get_tank_sprite_right

    get_tank_sprite_up:
    mov ax, enemy_tank_up
    jmp get_tank_sprite_end
    get_tank_sprite_down:
    mov ax, enemy_tank_down
    jmp get_tank_sprite_end
    get_tank_sprite_left:
    mov ax, enemy_tank_left
    jmp get_tank_sprite_end
    get_tank_sprite_right:
    mov ax, enemy_tank_right
    jmp get_tank_sprite_end
...
get_player_tank_sprite proc; output: ax - player_tank_sprite
    ...
    cmp al, direction_up
    je get_player_direction_up
    cmp al, direction_down
    je get_player_direction_down
    cmp al, direction_left
    je get_player_direction_left
    jmp get_player_direction_right

    get_player_direction_up:
    mov ax, player_tank_up
    jmp get_player_direction_end
    get_player_direction_down:
    mov ax, player_tank_down
    jmp get_player_direction_end
    get_player_direction_left:
    mov ax, player_tank_left
    jmp get_player_direction_end
    get_player_direction_right:
    mov ax, player_tank_right
    jmp get_player_direction_end
...
init proc
    ...
    mov al, min_x + 1; init enemies pos
    mov ah, min_y + 1
    mov cx, 0
...
choose_desired_action proc; al - ASCII, ah - scan_code; output: desired_action changed if legal
    cmp ah, 01h; Esc key
    je choose_desired_action_exit
    cmp ah, 11h; W key
    je choose_desired_action_up
    cmp ah, 1Eh; A key
    je choose_desired_action_left
    cmp ah, 1Fh; S key
    je choose_desired_action_down
    cmp ah, 20h; D key
    je choose_desired_action_right
    cmp ah, 39h; SpaceBar
    je choose_desired_action_shoot
...
deside_if_bullet_destroyed proc; al - new x, ah - new y; output: bl - bullet_state
    ...
    cmp dx, bullet
    je deside_if_bullet_destroyed_out_of_bound
    cmp dx, ground
    je deside_if_bullet_destroyed_fine
    ...
    cmp dx, enemy_base
    je deside_if_bullet_destroyed_destroyed_base
    cmp dx, player_tank_down
    je deside_if_bullet_destroyed_player_killed
    cmp dx, player_tank_up
    je deside_if_bullet_destroyed_player_killed
    cmp dx, player_tank_left
    je deside_if_bullet_destroyed_player_killed
    cmp dx, player_tank_right
    je deside_if_bullet_destroyed_player_killed
    jmp deside_if_bullet_destroyed_end
...
set_enemy_bullet_status_active proc; cx - enemy_index
    ...
    call get_enemy_status
    cmp al, tank_status_dead
    je set_enemy_bullet_status_active_dead
    cmp al, tank_status_dead_has_bullet
    je set_enemy_bullet_status_active_dead
...
set_enemy_bullet_status_inactive proc; cx - enemy_index
    ...
    call get_enemy_status
    cmp al, tank_status_dead
    je set_enemy_bullet_status_inactive_dead
    cmp al, tank_status_dead_has_bullet
    je set_enemy_bullet_status_inactive_dead
...
save_enemy_bullet_state proc; cx - enemy_index, bl - bullet_state
    ...
    cmp bl, bullet_fine
    je save_enemy_bullet_state_fine
...
save_player_bullet_status_active proc;
    ...
    cmp al, tank_status_dead
    je save_player_bullet_status_active_dead
    cmp al, tank_status_dead_has_bullet
    je save_player_bullet_status_active_dead
...
save_player_bullet_status_inactive proc;
    ...
    call get_player_status
    cmp al, tank_status_dead
    je save_player_bullet_status_inactive_dead
    cmp al, tank_status_dead_has_bullet
    je save_player_bullet_status_inactive_dead
...
save_player_bullet_state proc; bl - bullet_state
    ...
    cmp bl, bullet_fine
    je save_player_bullet_state_active
